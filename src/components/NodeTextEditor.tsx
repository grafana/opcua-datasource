...
export class NodeTextEditor extends PureComponent<Props, State> {
    constructor(props: Props) {
        super(props);
        this.state = { edit: false, node: this.props.node, editnode: this.props.node.node.nodeId, originalNodeId: this.props.node.node.nodeId };
    }
    ...
    render() {
        ...
        return (this.state.edit) ?
            (
                <div>
                    <Input placeholder={this.props.placeholder} value={this.state.editnode} /*onBlur={() => this.onSubmit()} onChange={(e) => this.onChange(e)} */></Input>
                </div>
            ) :
            (
                <div>
                    <Input placeholder={this.props.placeholder} value={ browsePathToShortString(this.props.node.browsePath)} /*onClick={() => this.setState({ edit: true })}*/ ></Input>
                </div>
            );
